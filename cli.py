...
class HermesCLI:
    ...
    def _init_agent(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        ...
        try:
            ...
            _ds_native_cfg = CLI_CONFIG.get("deepseek_native", {}) or {}
            _ds_routing_cfg = (_ds_native_cfg.get("routing", {}) or {}) if isinstance(_ds_native_cfg, dict) else {}
            self.agent = AIAgent(
                ...
                deepseek_routing_enabled=bool(_ds_routing_cfg.get("enabled", False)),
                deepseek_flash_model=_ds_routing_cfg.get("flash_model") or "deepseek-v4-flash",
                deepseek_pro_model=_ds_routing_cfg.get("pro_model") or "deepseek-v4-pro",
            )
